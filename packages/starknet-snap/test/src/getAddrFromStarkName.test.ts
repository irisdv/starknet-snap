...
import { ApiParams, GetAddrFromStarkNameRequestParam } from '../../src/types/snapApi';
...
describe('Test function: getAddrFromStarkName', function () {
  ...
  it('should retrieve the address from stark name successfully', async function () {
    ...
    expect(result).to.be.eq('0x01c744953f1d671673f46a9179a58a7e58d9299499b1e076cdb908e7abffe69f');
  });
